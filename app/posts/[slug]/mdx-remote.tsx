...
const components = {
  ...
  h3: props => (
    <h3 className="mb-4 mt-16 text-[31px]  [&>code]:text-[24px]">
      {props.children}
    </h3>
  ),
  p: props => (
    <p className="mb-6 text-[18px] font-normal leading-normal text-copy opacity-95 md:text-[17px] md:text-[20px] [&>code]:text-[17px] [&>em]:font-medium [&>em]:italic [&>em]:leading-normal">
      {props.children}
    </p>
  ),
